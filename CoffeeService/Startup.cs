    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           services.AddDbContext<CoffeeDBContext>(x=>x.UseSqlServer(Configuration.GetConnectionString("CoffeeDB")));
            GlobalInformation.ConnectionString = Configuration.GetConnectionString("CoffeeDB");

            services.AddTransient<ICoffeeLogic, CoffeeLogic>();
            services.AddTransient<ICoffeeStoreLogic, CoffeeStoreLogic>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapControllerRoute(
                     name: "DefaultApi",
                pattern: "api/{controller}/{action}/{id?}/{storeId?}",
